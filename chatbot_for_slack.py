...
# args, net, sess, chars, vocab, max_length, beam_width, relevance, temperature = None, None, None, None, None, None, None, None, None
...
def main():
    ...
    parser.add_argument('--relevance', type=float, default=.2,
