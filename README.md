# chatbot-rnn (update to Tensorflow 1.0.0 and Python3)
A toy chatbot powered by deep learning and trained on data from Reddit. Forked from here (https://github.com/pender/chatbot-rnn.git)
